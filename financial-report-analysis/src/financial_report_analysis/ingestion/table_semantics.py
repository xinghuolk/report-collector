...
_ROW_LABEL_ALIASES: dict[str, str] = {
    ...
    "bank balances and deposits": "cash and cash equivalents",
    ...
    "long term equity investments": "long-term equity investments",
    "investment in subsidiaries": "long-term equity investments",
    "investments in subsidiaries": "long-term equity investments",
    "investment in associates": "long-term equity investments",
    "investments in associates": "long-term equity investments",
    ...
    "gain on disposal of non-current assets": "gain on disposal of assets",
    "asset disposal income": "gain on disposal of assets",
    ...
    "tax paid": "taxes paid",
    "profits tax paid": "taxes paid",
    "cash paid for taxes": "taxes paid",
    "支付的各项税费": "taxes paid",
    "cash received from disposal of long-term assets": "cash received from disposal of long-term assets",
    "proceeds from disposal of property, plant and equipment and other long-term assets": "cash received from disposal of long-term assets",
    "处置固定资产、无形资产和其他长期资产收回的现金": "cash received from disposal of long-term assets",
    "cash received from investment returns": "cash received from investment returns",
    "cash received from investment income": "cash received from investment returns",
    "cash received from returns on investments": "cash received from investment returns",
    "取得投资收益收到的现金": "cash received from investment returns",
    "毛利润": "gross profit",
    "毛利": "gross profit",
    "营业毛利": "gross profit",
