...
当前 seed 包含 3 个 issuer，使用当前 `report/` 下载器可取得的年度报告：
...
- 3 个 issuer
- 每个 issuer 3-5 个可用 fiscal years
- annual reports only
...
- 3 issuers x available fiscal years x annual only
...
- **样本上**：`CN_601919`、`HK_09987`、`HK_01810` 的 available-year seed manifest 已够用
