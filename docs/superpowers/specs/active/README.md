...
Phase 2-4B, have been moved to `../archived/`. The active docs reconciliation
spec, explicit JSON-to-DB sync bridge baseline, and post-P5 profit enhancement
spec are also archived because their cleanup has been completed.
